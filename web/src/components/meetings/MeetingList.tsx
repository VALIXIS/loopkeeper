...
import { CalendarIcon, SearchIcon, PlusIcon, ArrowRightIcon, UsersIcon } from '../common/Icons';
    ...
    <div className="space-y-6 pb-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-gradient-to-r from-indigo-600 to-cyan-500 hover:from-indigo-500 hover:to-cyan-400 text-white text-xs font-bold shadow-lg shadow-indigo-600/20 transition-all hover:scale-105 active:scale-95 self-start sm:self-auto"
        >
          <PlusIcon size={16} />
      ...
      {/* Search & Filter bar */}
      <div className="flex items-center justify-between gap-4 p-4 rounded-2xl bg-zinc-900/80 border border-zinc-800">
        ...
        <div className="text-xs text-zinc-400 font-medium">
          Showing <span className="font-bold text-zinc-200">{filteredMeetings.length}</span> recorded meetings
        </div>
      </div>
        ...
        {filteredMeetings.map(meeting => {
          ...
          return (
            <div
              ...
              className="group cursor-pointer rounded-2xl bg-zinc-900/80 border border-zinc-800 hover:border-indigo-500/50 p-5 shadow-lg transition-all duration-200 flex flex-col justify-between gap-4 hover:shadow-indigo-500/10 hover:-translate-y-0.5"
            >
              <div>
